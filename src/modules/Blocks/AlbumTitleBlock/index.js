...
const AlbumTitleBlock = withEnterExitAnimation(({listOfGenres, albumName, path, artistName}) => {
    return (
...
const AnimatedAlbumTitleBlock = (props) => {
    const condition = !isEmpty(props.albumName && props.path && props.listOfGenres  && props.artistName)
    return (
        <AlbumTitleBlock is={condition} {...props}/>
    )
}


export{
    AnimatedAlbumTitleBlock as AlbumTitleBlock
}
