...
class Artists extends Component {
  ...
  getTagsItems = tag => {
    ...
    return getTagTopArtists(tag, limit, data => {
      if (data) {
        const preData = data.artist.filter(
          item =>
        ...
        const newData = preData.map(item => {
          return {
            ...
            images: item.image.map(im => im["#text"]),
          }
        })
        this.setState({
          ...this.state,
        ...
        <div className="artistsPage">
          ...
          <div className="artistsPage-filters">
            ...
            <FilterGenres
              ...
              callback={this.getTagsItems}
              tagIsSelected={this.state.tagIsSelected}
              nameOfTag={nameOfTag}
            />
          </div>
        </div>
...
export { ArtistOrArtists as Artists }
